...
class Resource(BaseResource):
    ...
    def get_resources(self):
        ...
        for zone in self.zones:
            request = client.instances().list(project=self.project, zone=zone)# pylint: disable=maybe-no-member
    ...
    def delete_resources(self, resources, options=None):
        ...
        for resource in resources:
            try:
                response = client.instances().delete(# pylint: disable=maybe-no-member
