...
class Resource(BaseResource):
    ...
    def get_resources(self):
        ...
        client = self.client
        request = client.snapshots().list(project=self.project)# pylint: disable=maybe-no-member
    ...
    def delete_resources(self, resources, options=None):
        ...
        for resource in resources:
            try:
                response = client.snapshots().delete(# pylint: disable=maybe-no-member
